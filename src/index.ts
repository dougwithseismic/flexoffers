 ...
 */
const getAdvertiserTerms = async (advertiserId: string): Promise<AdvertiserTerm[]> => {
    ...
    try {
        ...
        console.error(`Failed to fetch advertiser terms for advertiserId=${advertiserId}: ${error}`)
        throw error
    }
}
 ...
 * @throws Will throw an error if the fetch operation fails.
 */
const applyToAdvertiser = async (advertiserId: string): Promise<ApplyResponse> => {
    ...
    try {
        ...
        console.error(`Failed to apply to advertiser with advertiserId=${advertiserId}: ${error}`)
        throw error
    }
}
 ...
 * @throws Will throw an error if the fetch operation fails.
 */
const getAdvertisers = async (params: AdvertisersQueryParams): Promise<Advertiser[]> => {
 ...
 */
const createDeepLink = async (params: CreateDeepLinkParams): Promise<DeeplinkResponse> => {
...
const getCoupons = async (params: GetCouponsParams): Promise<PromotionalLink[]> => {
...
const getPromotionTypes = async (params: GetPromotionTypesParams): Promise<PromotionType[]> => {
...
const getPromotionTypesCountByAdvertiserId = async (
    ...
    try {
        const promotionTypesCount = await doFetch<PromotionTypeCount[]>(url.toString())
...
const getProductAdvertisers = async (
    ...
    try {
        const productAdvertisers = await doFetch<ProductAdvertiser[]>(url.toString())
...
const getProductCatalogs = async (params: GetProductCatalogsParams): Promise<ProductCatalog[]> => {
...
const getAllCatalogs = async (params: GetAllCatalogsParams): Promise<Catalog[]> => {
...
const getProductCategories = async (params: GetProductCategoriesParams): Promise<Category[]> => {
...
const getProductCount = async (params: GetProductCountParams): Promise<ProductCount> => {
...
const getProducts = async (
    ...
    try {
        const shortProductDescriptions = await doFetch<ShortProductDescription[]>(url.toString())
 ...
 */
const getFullProducts = async (params: GetFullProductsParams): Promise<FullProduct[]> => {
 ...
 */
const getProductFeeds = async (params: GetProductFeedsParams): Promise<ProductFeed[]> => {
 ...
 */
const getPaymentSummary = async (params: GetPaymentSummaryParams): Promise<PaymentSummary[]> => {
 ...
 */
const getPaymentDetails = async (params: GetPaymentDetailsParams): Promise<PaymentDetails[]> => {
